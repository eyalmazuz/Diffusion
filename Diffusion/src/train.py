    ...
    for epoch in range(epochs):
        for step, batch in enumerate(dataloader):
            ...
            if step % 100 == 0:
                ...
                torch.save(diffusion_model.model, os.path.join(model_save_path, f'regular_{epoch+1}_{step+1}.pth'))
                torch.save(ema_model, os.path.join(model_save_path, f'ema_{epoch+1}_{step+1}.pth'))
